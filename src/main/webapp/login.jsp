...
<body>
	<div
		class="v3-app-layout layoutstatus-header--Normal layoutstatus-side--Hidden limitWidth header-theme--">
                            ...
                            <div class="content-main content-main-modal">
                                <form  action="user/login" method="post" class="form-main">
                                    ...
                                    <button onclick="login()" id="sso_submit"
                                        ...
                                        style="background-color: rgb(248,127,22); cursor: pointer;">登录</button>
                                    <a href="user/reg" target="_self" style="float:right;color: #ff6f00;text-decoration:none;">没有帐号，前去注册></a>
                                </form>
                            </div>
                        </div>
                    </div>

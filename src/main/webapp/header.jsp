    ...
    <div class="siteHeader">
        <div class="siteHeader__inner">
            ...
            <div class="search-wrap">
                ...
                <div class="SearchPreset show border-blue" style="height: 33px; margin: 4px 0">
                    <ul></ul>
                </div>
                <a id="search" class="search-btn   border-blue"><i class="icon-search btn__search"></i><span>搜索</span></a>
                            ...
                            <li>
                                <a   href="" target="_blank" data-disable_default="true">
                                    <div onmousemove="over()" onmouseout="out()" class="BU-Component-Header-Avatar__image"
                                        style="display: inline-block; width: 44px; height: 44px; border-radius: 22px; background-size: 100%; background-image: url(${pageContext.request.contextPath }/images/${sessionScope.user.photoUrl}); cursor: pointer">
